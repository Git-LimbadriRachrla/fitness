...
function TrackGoals() {
  return (
    <div className="m-4 h-screen">
      <Link className="text-base underline text-[#9FB2FF] flex justify-end" to="/signup">
        Skip
      </Link>
      <div className="mt-[4.5rem] flex justify-center">
        <img className="h-72" src={ManCycling} alt="Man cycling" />
      </div>
      <div className="font-semibold text-xl mt-14">Get Burn</div>
